...
const MsgEvent = require('../middleware/MsgEvent').default;
    ...
    function webRtcPlayer(parOptions) {
        ...
        handleOnAudioTrack = function (audioMediaStream) {
            ...
            // video element has some other media stream that is not associated with this audio track
                ...
                audioElem.play();
                MsgEvent.webrtc.log('Created new audio element to play seperate audio stream.');
            }
        ...
        setupDataChannel = function (pc, label, options) {
            try {
                ...
                MsgEvent.webrtc.warn('No data channel', e);
                return null;
            }
        }
